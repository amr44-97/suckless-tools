...
X11INC = /home/amr/libxft/include
X11LIB = /home/amr/libxft/src/.libs
...
STCFLAGS = $(INCS) $(STCPPFLAGS) $(CPPFLAGS) -O2 $(CFLAGS)
STLDFLAGS =  -Xlinker -rpath=$(X11LIB) $(LIBS) $(LDFLAGS)
#STLDFLAGS = $(LIBS) $(LDFLAGS) +STLDFLAGS = -Xlinker -rpath=$(X11LIB) $(LIBS) $(LDFLAGS)
