...
#if BAR_PANGO_PATCH
static const char font[]                 = "CaskaydiaCove Nerd Font 11";
#else
static const char *fonts[]               = { "CaskaydiaCove Nerd Font 11"  };
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "CaskaydiaCove Nerd Font  :size=11"   ;
...
//const char *spcmd1[] = {"konsole", "--name" ,"spterm", "--geometry", "1120x834", NULL };
